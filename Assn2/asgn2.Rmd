...
par(mfrow = c(1,2))
boxplot(dt_scores, main = "Dt accuracy", ylim = c(0.5,1.0))
boxplot(log_scores, main = "logistic accuracy", ylim = c(0.5,1.0))
...
results = data.frame(rf1, rf5, rf10, rf20, log_scores, dt_scores)
boxplot(results)
```
